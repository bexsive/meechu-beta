...
public class EventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        event = new Event();
        event.setId(bundle.getInt("event_id"));
        ...
        // TODO: If you call this too quickly in onCreate the app fails
        checkAttendance();
    }
    ...
    void checkAttendance(){
        ...
        Call<EventParticipant> call = api.check_attendance(preferenceConfig.readUserId(), event.getId());
        ...
        call.enqueue(new Callback<EventParticipant>() {
            ...
            public void onResponse(Call<EventParticipant> call, Response<EventParticipant> response) {
                ...
                if (response.body().getId() == null){
                    ...
                    eventParticipant.setUserId(preferenceConfig.readUserId());
                    ...
                    eventParticipant.setCreator(response.body().getCreator());
                    eventParticipant.setAdmin(response.body().getAdmin());
                    eventParticipant.setId(response.body().getId());

                    //Change button visibility
                    if (eventParticipant.getAttending()){
    ...
    void updateStatus(){
        ...
        if (isNew){
            ...
            Call<EventParticipant> call = api.createEventParticipant(headerMap, eventParticipant);
            call.enqueue(new Callback<EventParticipant>() {
                @Override
                public void onResponse(Call<EventParticipant> call, Response<EventParticipant> response) {

                    if (response.body().getAttending()) {
